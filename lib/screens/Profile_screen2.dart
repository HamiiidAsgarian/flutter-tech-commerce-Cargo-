    ...
    return Scaffold(
      ...
      Padding(
        ...
        child: Column(
          ...
          IcondataString(iconData: Icons.timelapse, string: 'Price Changes'),
          IcondataString(iconData: Icons.favorite, string: 'Favorites'),
          IcondataString(iconData: Icons.receipt_long, string: 'Recent views'),
      ...
      Padding(
        ...
        child: Column(
          ...
          IcondataString(iconData: MyFlutterApp.bell_alt, string: 'Contacts'),
          IcondataString(iconData: MyFlutterApp.bell_alt, string: 'Version'),
